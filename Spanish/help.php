...
'Bold text'				=>	'Negrita',
'Underlined text'		=>	'Subrayado',
'Italic text'			=>	'Itálica',
'Strike-through text'	=>	'Tachado',
'Red text'				=>	'Texto rojo',
'Blue text'				=>	'Texto azul',
'Heading text'			=>	'Cabeceras',
'Deleted text'			=>	'Borrar texto',
'Inserted text'			=>	'Insertar texto',
'Emphasised text'		=>	'Destacar texto',
...
'Quotes'				=>	'Notas',
'Quotes info'			=>	'Si quieres añadir alguna nota, usa la etiqueta quote.',
...
'Code text'				=>	'Esto es un ejemplo de código.',
'produces code box'		=>	'produce una caja de texto como esta:',

'Nested tags'			=>	'Etiquetas anidadas',
'Nested tags info'		=>	'Puedes anidar varias etiquetas para mejorar la visualización. Por ejemplo:',
'Bold, underlined text'	=>	'Negrita, texto subrayado',

'Lists'					=>	'Listas',
'List info'				=>	'Puedes crear listas usando la etiqueta list. Hay 3 tipos de listas que puedes usar.',
'List text 1'			=>	'Ejemplo 1.',
'List text 2'			=>	'Ejemplo 2.',
'List text 3'			=>	'ejemplo 3.',
'produces list'			=>	'genera una lista con viñetas.',
'produces decimal list'	=>	'genera una lista numérica.',
'produces alpha list'	=>	'genera una lista ordenada alfabéticamente.',

'Smilies'				=>	'Emoticonos',
'Smilies info'			=>	'Si lo deseas (y esta activado) puedes añadir emoticonos usando sus equivalentes de texto (como los que se usan aun en los chats vía IRC:'
